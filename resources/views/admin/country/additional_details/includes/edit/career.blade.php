    ...
    <div class="row">
        <div class="mb-4">
            ...
            <input type="text" class="form-control" id="career_subtitle" name="career_subtitle"
                placeholder="Career Counseling Subtitle"
                value="{{ old('career_subtitle', ${$name}->career_subtitle) }}" />
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control ckeditor1" id="career_description" name="career_description"
                placeholder="Career Counseling Description" rows="10">{{ old('career_description', ${$name}->career_description) }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input class="form-control dropify" type="file" id="career_image" name="career_image"
                value="{{ old('career_image', ${$name}->career_image) }}"
                data-default-file="{{ asset(${$name}->career_image) }}" />
            ...
            <div class="form-check form-switch form-switch-danger">
                <input class="form-check-input custom-switch-red" type="checkbox" id="delete-career_image"
                    name="deletecareer_image" />
                <label class="form-check-label" for="delete-career_image">Delete</label>
            </div>
        </div>
    </div>
</div>
