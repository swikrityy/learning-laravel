<div class="nav-align-top mb-4">
    ...
    <div class="tab-content">
        ...
        @include('admin.country.additional_details.includes.create.career')

        @include('admin.country.additional_details.includes.create.university')

        @include('admin.country.additional_details.includes.create.visa')

        @include('admin.country.additional_details.includes.create.documentation')

        @include('admin.country.additional_details.includes.create.financial')

        @include('admin.country.additional_details.includes.create.departure')
