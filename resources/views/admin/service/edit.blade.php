                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-4 text-2xl">
                                <label for="featured_icon" class="form-label">Featured Icon</label>
                                <input class="form-control" id="featured_icon" name="featured_icon"
                                    value="{{ old('featured_icon', ${$name}->featured_icon) }}" />
