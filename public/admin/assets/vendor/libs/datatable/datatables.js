...
(function (factory) {
    ...
    function _fnBuildHead(settings, side) {
        ...
        if (
            side === "header" ||
            _pluck(settings.aoColumns, titleProp).join("")
        ) {
            row = $("tr", target);
    ...
    function _layoutArray(settings, layout, side) {
        ...
        $.each(layout, function (pos, val) {
            ...
            var align =
                splitPos.length === 1 ? "full" : splitPos[1].toLowerCase();
        ...
        var resolve = function (item) {
            ...
            for (var i = 0, ien = line.length; i < ien; i++) {
                if (!line[i]) {
                    ...
                    line[i] =
                        typeof inst.node === "function" ? inst.node() : inst;
                }
            }
        };
            ...
            columns: columns.map(function (column, i) {
                return {
                    ...
                    search: {
                        ...
                        fixed: Object.keys(column.searchFixed).map(function (
                            name
                        ) {
                            return {
                                name: name,
    ...
    function _fnFilter(searchRows, settings, input, options, column) {
        ...
        for (i = 0; i < searchRows.length; i++) {
            ...
            if (
                (searchFunc &&
                    searchFunc(data, row._aData, searchRows[i], column)) ||
    ...
    function _processingHtml(settings) {
        var table = settings.nTable;
        var scrolling =
            settings.oScroll.sX !== "" || settings.oScroll.sY !== "";
    ...
    function _fnGetMaxLenString(settings, colIdx) {
        ...
        if (!column.maxLenString) {
            ...
            for (
                var i = 0, ien = settings.aiDisplayMaster.length;
                i < ien;
                i++
            ) {
    ...
    var __setColumnVis = function (settings, column, vis) {
        ...
        if (vis) {
            ...
            var insertBefore = _pluck(cols, "bVisible").indexOf(
                true,
                column + 1
            );
    ...
    $.each(["column", "row", "cell"], function (i, type) {
        _api_register(type + "s().every()", function (fn) {
            ...
            return this.iterator(
                "every",
                function (settings, selectedIdx, tableIdx) {
            ...
            _: function (settings, cell, classes) {
                ...
                $(settings.nTable).on(
                    ...
                    function (e, ctx, sorting) {
                        ...
                        var sortIdx = orderedColumns.indexOf(
                            "," + indexes.toArray().join(",") + ","
                        );
                        ...
                        if (sortIdx === 0) {
                            ...
                            ariaType = !sortOrder[firstSort.index + 1]
                                ? "Remove"
                                : "Reverse";
                        } else {
                        ...
                        if (orderable) {
                            cell.find(".dt-column-title").attr(
                                "role",
                                "button"
                            );
    ...
    DataTable.feature.register(
        ...
        function (settings, opts) {
            ...
            var host = $("<div/>").addClass(
                settings.oClasses.paging.container + " paging_" + opts.type
            );
            var draw = function () {
    ...
    DataTable.feature.register(
        ...
        function (settings, opts) {
            ...
            var div = $("<div/>")
                .addClass(classes.container)
                .append(str.replace("_MENU_", "<span></span>"));
